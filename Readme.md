npm init is a command-line instruction used to create a package. json file for a Node. js package. The package. json file stores metadata and dependencies for your package, 
